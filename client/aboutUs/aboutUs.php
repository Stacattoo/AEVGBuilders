  ...
  <div class="container-fluid">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
        <img src="../../images/aevg.png" class="img-logo bg-dark" height="45">
      </a>
    ...
    <div class="row ">
      <div class="col-md-4 d-flex align-items-center ">
        <div>
          ...
          <p class="lead mb-2"> <i class="mx-2 fas fa-map-marker-alt"></i> <span id="aboutUsAddress">002 San Pablo, Hagonoy Bulacan</span></p>
          <p class="lead mb-2"> <i class="mx-2 fas fa-phone-alt"></i> <span id="aboutUsContact">+63 977 852 7307.</span></p>
          <p class="lead "><i class="mx-2   fas fa-envelope"></i> <span id="aboutUsEmail">evgalangdesign@gmail.com</span></p>
        </div>
      </div>
      <div class="col-md-8">
